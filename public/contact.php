    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 3rem; margin-bottom: 3rem;">
        ...
        <div>
            <div class="card" style="margin-bottom: 2rem;">
                ...
                <p>
                    <strong>Support:</strong> support@skillbridge.com<br>
                    <strong>General:</strong> hello@skillbridge.com
                </p>
            </div>
    ...
    <div class="card">
        ...
        <div style="display: grid; gap: 1rem;">
            ...
            <div style="padding: 1rem; background: var(--light-blue); border-radius: 0.5rem;">
                ...
                <p style="color: var(--dark-gray); margin: 0;">
                    Currently, SkillBridge is completely free for both job seekers and employers. We're focused on building our community!
                </p>
            </div>
