...
<section class="dashboard-header">
    <div class="container">
        <div class="dashboard-welcome">
            <h1>About Free<span>Lance</span>Portal</h1>
...
<section class="container">
    ...
    <!-- Team Section -->
    <div class="card" style="margin-bottom: 3rem;">
        <h2 style="text-align: center; color: var(--dark-blue); margin-bottom: 2rem;">Why Choose FreeLancePortal?</h2>
    ...
    <div class="card" style="text-align: center;">
        ...
        <p style="color: var(--dark-gray); margin-bottom: 2rem; max-width: 600px; margin-left: auto; margin-right: auto;">
            Join our growing community today and discover how FreeLancePortal can transform 
